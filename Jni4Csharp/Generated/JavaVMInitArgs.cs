...
public class JavaVMInitArgs : global::System.IDisposable {
  ...
  public /* cstype jboolean */ bool ignoreUnrecognized {
    set {
      // csvarin jboolean
      JNIPINVOKE.JavaVMInitArgs_ignoreUnrecognized_set(swigCPtr, /* csin jboolean */ value);
    } 
    get {
      // csvarout jboolean
      bool ret = JNIPINVOKE.JavaVMInitArgs_ignoreUnrecognized_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public int length() {
    int ret = JNIPINVOKE.JavaVMInitArgs_length(swigCPtr);
    return ret;
  }
  ...
  public /* cstype jboolean */ bool isIgnoreUnrecognized()  {
    // csout jboolean
    bool ret = JNIPINVOKE.JavaVMInitArgs_isIgnoreUnrecognized(swigCPtr);
    return ret;
  } 

  public void setIgnoreUnrecognized(/* cstype jboolean */ bool value) {
    JNIPINVOKE.JavaVMInitArgs_setIgnoreUnrecognized(swigCPtr, /* csin jboolean */ value);
  }
